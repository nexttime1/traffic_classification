...
def transform_pcap(path):
    ...
    app_label = PREFIX_TO_TorApp_ID.get(prefix)
    service_label = None
    c = 0
...
if __name__ == '__main__':
    source =  "/home/user/xtm/datasets/tor/"
    # source =  "/home/user/xtm/Encrypted-Traffic-Classification-Models/dataset/raw_pcap/"
